...
print(are_last_symbols_same("Tere", "asijfas"))
print(are_last_symbols_same("Tere", "Ehe"))


def hundred(num_a: int) -> int:
    """
    Given a positive integer num_a. If its smaller or equal to 100 return 100 - num_a.
    Else return the reminder from dividing it with 100.
